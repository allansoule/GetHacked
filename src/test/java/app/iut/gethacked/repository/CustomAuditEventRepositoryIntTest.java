...
import app.iut.gethacked.config.audit.AuditEventConverter;
import app.iut.gethacked.domain.PersistentAuditEvent;
...
import static app.iut.gethacked.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
